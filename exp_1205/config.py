"""
配置文件 - exp_1204: Curriculum Learning + Mixed Loss
...
新增參數:
- use_curriculum: 是否啟用 curriculum learning
- mse_weight: MSE Loss 權重
- ce_weight: CE Loss 最終權重
- initial_temperature: 初始溫度
- final_temperature: 最終溫度
- curriculum_mode: 漸進模式 ('linear', 'cosine', 'step')
- warmup_epochs: MSE 為主的 warm-up 階段
- transition_epochs: 漸進轉換階段
"""
...
class TrainConfig:
    ...
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    # exp_1204: Curriculum Learning 參數
    # ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    use_curriculum: bool = True          # 是否啟用 curriculum learning
    mse_weight: float = 1.0              # MSE Loss 權重
    ce_weight: float = 0.5               # CE Loss 最終權重（會從 0 漸進到這個值）
    initial_temperature: float = 2.0     # 初始溫度（軟監督）
    final_temperature: float = 0.1       # 最終溫度（硬監督）
    curriculum_mode: str = 'linear'      # 漸進模式: 'linear', 'cosine', 'step'
    curriculum_warmup_epochs: int = 5    # MSE 為主的 warm-up 階段
    transition_epochs: int = 20          # 漸進轉換階段
