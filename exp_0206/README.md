...
```bash
# 使用 GPU 0 (預設)
bash exp_0206/run.sh

# 使用 GPU 1
bash exp_0206/run.sh 1

# 自定義實驗名稱
bash exp_0206/run.sh 0 my_experiment
```

## 輸出結構

```
exp_0206/runs/<exp_name>_<timestamp>/
├── config.json           # 完整配置
├── train.log             # 訓練日誌
...
```
V1: python exp_0206/train_long.py   --intermediate_weight 0.5  --intermediate_weight_min 0.25  --warmdown_epochs 50
V2: python exp_0206/train_long_v2.py --intermediate_weight 0.03  (no warmdown params)
```
