...
- [ ] 測試 EMA update
- [ ] 測試 dead-code reset
- [ ] **執行**: `python exp_0206/plan_ori/test_single_vq_ema.py`
- [ ] 所有測試通過 ✅
...
- [ ] 確認資料路徑存在
- [ ] **執行**: `bash exp_0206/plan_ori/run_exp_ori_short.sh 0`
- [ ] 記錄開始時間
...
- [ ] **執行**: `python exp_0206/plan_ori/analyze_results.py <output_dir>`
- [ ] 查看 metrics curves
- [ ] 查看 P2/P3 判定
