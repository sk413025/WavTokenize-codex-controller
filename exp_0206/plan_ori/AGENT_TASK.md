...
**檔案**: `exp_0206/plan_ori/models_single_vq_ema.py`
...
**檔案**: `exp_0206/plan_ori/train_single_vq_ema.py`

**基於**: 參考 `exp_0206/train_long_v2.py` 並修改
...
**檔案**: `exp_0206/plan_ori/run_exp_ori_short.sh`
...
OUTPUT_DIR="exp_0206/runs/plan_ori_short_${TIMESTAMP}"
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python exp_0206/plan_ori/train_single_vq_ema.py \
...
**檔案**: `exp_0206/plan_ori/test_single_vq_ema.py`
...
**執行**:
```bash
python exp_0206/plan_ori/test_single_vq_ema.py
```
...
**執行**:
```bash
bash exp_0206/plan_ori/run_exp_ori_short.sh 0
```
...
**分析腳本**: `exp_0206/plan_ori/analyze_results.py`
...
**檔案**: `exp_0206/plan_ori/RESULTS.md`
...
更新以下文件的狀態:
- [ ] `exp_0206/plan_ori/README.md` - 更新狀態為 🟢/🟡/🔴
- [ ] `exp_0206/README.md` - 加入 Plan Original 結果連結
- [ ] 主 README - 更新實驗進度
...
- **Baseline**: `exp_0112_intermediate/models.py`
