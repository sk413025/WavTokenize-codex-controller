...
python exp_0206/plan_ori/train_single_vq_ema.py \
    --mode step \
    --steps 1000 \
    --output_dir exp_0206/runs/plan_ori_v2_short \
    --eval_interval 200
...
```bash
# 300 epochs 完整訓練
bash exp_0206/plan_ori/run_exp_ori_long_v2.sh 0
```
...
# 對比 V2
python exp_0206/compare_audio_quality.py \
    --plan_ori exp_0206/runs/plan_ori_v2_long \
    --v2 exp_0206/runs/longterm_20260208_114702
```
...
1. ✅ **檢查維度問題**
   ...
   python -c "
   import torch
   ckpt = torch.load('exp_0206/runs/plan_ori_long_20260211/checkpoints/checkpoint_epoch300.pt')
...
2. ✅ **創建 Plan Original V2 分支**
   ```bash
   mkdir -p exp_0206/plan_ori_v2
   cp exp_0206/plan_ori/models_single_vq_ema.py exp_0206/plan_ori_v2/
   ```
