#!/bin/bash
# ============================================================
# Exp36: Feature Loss Only (基於 Exp35 配置)
# ============================================================
#
# 假設: Triplet Loss 可能是干擾項，測試純 Feature Loss
#
# 基於 Exp35 配置，唯一差別:
# - feature_weight: 1.0 (保持)
...
echo "============================================================"
echo "Exp36: Feature Loss Only (基於 Exp35)"
echo "============================================================"
echo "  - lr: 1e-4, warmup: 10 epochs"
echo "  - lora_rank: 128, dropout: 0.2"
echo "  - feature=1.0, triplet=0, ce=0"
echo "  - epochs: 100"
echo "============================================================"

python train_aligned.py \
    --exp_name exp36_feature_only \
    --lora_rank 128 \
    --lora_alpha 256 \
    --lora_dropout 0.2 \
    --weight_decay 0.05 \
