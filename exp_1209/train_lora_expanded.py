"""
exp_1209: 方案 B+A - 擴大 LoRA + 方向性 Loss 訓練腳本

使用 18 層 LoRA (rank=256) 修正 encoder，搭配 Triplet Loss

架構:
    Noisy Audio → Encoder(LoRA 18層, rank=256) → VQ → tokens
"""
...
from exp_1209.models import TeacherStudentExpandedLoRA
...
def main():
    ...
    主訓練函數
    """
    parser = argparse.ArgumentParser(description='Exp1209: Expanded LoRA + Triplet Loss')
