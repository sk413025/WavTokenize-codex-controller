...
echo "5. 指定語者分割: 訓練集[boy1,3,4,5,6+girl2,3,4,6,7] vs 驗證集[girl9,boy7]"
echo "====================================================="
...
echo "5. **指定語者分割:** 訓練集10位語者 vs 驗證集2位語者" >> $REPORT_FILE
echo "" >> $REPORT_FILE
...
echo "- **訓練語者:** boy1,boy3,boy4,boy5,boy6,girl2,girl3,girl4,girl6,girl7" >> $REPORT_FILE
echo "- **驗證語者:** girl9,boy7" >> $REPORT_FILE
