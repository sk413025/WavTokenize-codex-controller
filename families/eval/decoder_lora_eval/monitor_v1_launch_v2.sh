...
#
# 用法：
#   nohup bash families/eval/decoder_lora_eval/monitor_v1_launch_v2.sh > families/eval/decoder_lora_eval/monitor.log 2>&1 &
# ============================================================
...
# ===== 配置 =====
V1_PID=2150799
V1_RUN_DIR="families/eval/decoder_lora_eval/runs/decoder_lora_epoch_20260223_010247"
