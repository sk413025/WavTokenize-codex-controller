...
日期：2026-02-19  
範圍：`families/deps/encoder_aug/runs/augmented_long_20260216`（不改設定先評估）
...
- 證據：
  ...
  - `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/statistical_tests_summary.md`

### Secondary：H1 資料分布差異（Partial Support）
- 事實：T453 分桶在 val@epoch300 出現顯著差異（FDR 後仍顯著的比較存在）。
- 證據：
  - `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/stratified_quality_report.md`
  - `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/statistical_tests_summary.md`

### Secondary：H3 容量/量化瓶頸（Partial Support）
- 事實：`with_vq` 相對 `no_vq` 有負向差距，但不足以單獨定主因。
- 證據：
  - `families/deps/encoder_aug/PESQ_STOI_novq_comparison.json`
  - `THESIS_ARCHITECTURE.md`

### H4 增強副作用（Insufficient Evidence）
- 事實：無直接對照 ablation 證據可歸因。
- 證據：
  - `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/hypothesis_scoring.json`
...
證據：
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/spec_coverage_status_20260219.json`
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/next_experiment_recommendation.md`
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/statistical_tests_summary.json`
...
- 已完成 `epoch220 -> epoch222` 同設定 replay，產生補件 checkpoint 與音質評估：
  - `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/replay_from220_to222/checkpoints/checkpoint_epoch222_replay.pt`
...
證據：
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/M1_ACCEPTANCE_EVALUATION_20260222.md`
...
### 文件入口
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/M2_DEFINITION_20260223.md`
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/M2_EXECUTION_GATE_20260223.md`
- `families/deps/t453_weighted_baseline/runs/t453_weighted_epoch_20260217_104843/cross_experiment_300epoch_check_20260219.json`
...
證據：
- `families/deps/t453_weighted_baseline/analysis_commit_5e859b0/M2_ACCEPTANCE_EVALUATION_20260223.md`
