...
執行方式：
    python families/deps/no_vq_scratch/train_no_vq_scratch_decoder_lora_fm.py \\
    ...
    # Smoke test
    python families/deps/no_vq_scratch/train_no_vq_scratch_decoder_lora_fm.py --mode smoke
"""
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/deps/no_vq_scratch/runs/no_vq_scratch_dec_lora_fm_{args.mode}_{timestamp}')
