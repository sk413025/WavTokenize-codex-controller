...
while true; do
    ...
    LATEST_B=$(ls -dt "$BASE/families/deps/no_vq_scratch/runs/no_vq_scratch_dec_lora_epoch_"* 2>/dev/null | head -1 || true)
...
# -------------------------------------------------------
ENCODER_CKPT=$(ls -t "$BASE/families/deps/no_vq_scratch/runs/no_vq_scratch_epoch_"*/best_model_val_total.pt 2>/dev/null | head -1 || true)
