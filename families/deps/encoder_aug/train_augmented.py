...
基於 families/compat_legacy/plan_ori_vq/plan_ori/train_single_vq_ema.py 修改，核心變更：
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/deps/encoder_aug/runs/augmented_{args.mode}_{timestamp}')
