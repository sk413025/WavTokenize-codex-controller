...
# 用法: bash families/deps/selective_lora/wait_and_launch_planb.sh &

set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
LOG_A="${ROOT_DIR}/families/deps/anchor_regularization/runs/exp0305b_tail_lock_20260305_033323/train.log"
...
echo "${PID}" > "${ROOT_DIR}/families/deps/selective_lora/planb_pid.txt"
echo "[$(date)] 完成！監控："
