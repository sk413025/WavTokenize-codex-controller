...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python families/official/hubert_then_distalign/train_enc_hubert_fm_distalign.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python families/official/hubert_then_distalign/train_enc_hubert_fm_distalign.py \\
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/official/hubert_then_distalign/runs/enc_hubert_fm_dist_{args.mode}_{timestamp}')
