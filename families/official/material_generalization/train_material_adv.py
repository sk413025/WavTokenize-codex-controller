...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python families/official/material_generalization/train_material_adv.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python families/official/material_generalization/train_material_adv.py \\
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/official/material_generalization/runs/material_adv_{args.mode}_{timestamp}')
