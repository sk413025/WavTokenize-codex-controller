...
策略：
- 每 phase_advance_epochs 個 epoch 進入下一個 phase
- 每個 phase 增加 phase_increment 比例的資料
- 初始只使用 initial_phase 比例的簡單資料

配置 (基於 Exp55):
- 使用 Feature + Triplet Loss
- Curriculum mode: 從易到難
"""
...
def main():
    parser = argparse.ArgumentParser(description='Exp64: Curriculum Learning')

    # Experiment
    parser.add_argument('--exp_name', type=str, default='exp64_curriculum')
    ...
    print("=" * 60)
    print(f"Exp64: Curriculum Learning")
    ...
    history = {
        ...
        'train_dist': [], 'val_dist': [],
        'train_avg_snr': [],  # NEW: 追蹤平均 SNR
        'curriculum_phase': [],  # NEW: 追蹤 curriculum phase
        'lr': [],
    }
