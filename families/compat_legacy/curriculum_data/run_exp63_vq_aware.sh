...
python families/compat_legacy/curriculum_data/train_exp63_vq_aware.py \
    --exp_name exp63_vq_aware \
    --output_dir /home/sbplab/ruizi/WavTokenize-self-supervised/families/compat_legacy/curriculum_data/runs/exp63_vq_aware \
    --lora_rank 256 \
    --lora_alpha 512 \
    --lora_dropout 0.2 \
    --lora_layers all_18 \
    ...
    --warmup_epochs 10 \
    --grad_clip 1.0 \
    2>&1 | tee families/compat_legacy/curriculum_data/exp63.log
