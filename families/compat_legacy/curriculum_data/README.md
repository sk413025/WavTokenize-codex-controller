...
bash families/compat_legacy/curriculum_data/run_exp62_capacity.sh

# Exp63: VQ-Aware Loss (完成, 0.95%)
bash families/compat_legacy/curriculum_data/run_exp63_vq_aware.sh

# Exp64: Curriculum Learning (完成, 1.06% - BEST)
bash families/compat_legacy/curriculum_data/run_exp64_curriculum.sh

# Exp65: Anti-Collapse (完成, 0.69% - 正則化太強)
bash families/compat_legacy/curriculum_data/run_exp65_anti_collapse.sh

# Exp66: Post-VQ Feature Loss (完成, 崩潰)
bash families/compat_legacy/curriculum_data/run_exp66_post_vq.sh

# === 進行中實驗 ===
# Exp67: Curriculum + VQ-Aware 組合 (進行中, GPU 1)
bash families/compat_legacy/curriculum_data/run_exp67_curriculum_vq.sh

# Exp68: Post-VQ Loss 修復版 (進行中, GPU 2)
bash families/compat_legacy/curriculum_data/run_exp68_post_vq_fixed.sh

# === 待執行實驗 ===
# Exp69: Anti-Collapse 輕量版 (weight 降到 0.01)
bash families/compat_legacy/curriculum_data/run_exp69_anti_collapse_light.sh
```
