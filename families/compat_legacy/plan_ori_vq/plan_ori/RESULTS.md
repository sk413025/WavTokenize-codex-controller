...
- Metrics curves: `families/compat_legacy/plan_ori_vq/runs/plan_ori_short_20260211/metrics_curves_20260211_033803_plot_step_metrics.png`
- Analysis plot: `families/compat_legacy/plan_ori_vq/runs/plan_ori_short_20260211/analysis_curves_20260211_034141_analyze_results.png`
- Train log: `families/compat_legacy/plan_ori_vq/runs/plan_ori_short_20260211/train.log`
...
python families/compat_legacy/plan_ori_vq/plan_ori/train_single_vq_ema.py \
    ...
    --seed 42 \
    --output_dir families/compat_legacy/plan_ori_vq/runs/plan_ori_short_$(date +%Y%m%d)

# 分析結果
python families/compat_legacy/plan_ori_vq/plan_ori/analyze_results.py families/compat_legacy/plan_ori_vq/runs/plan_ori_short_<date>
```
