...
執行:
    bash families/compat_legacy/intermediate_stack/run_exp_k_v3.sh
"""
...
from families.compat_legacy.intermediate_stack.models_v3 import IntermediateSupervisionLossV3, get_exp_k_v3_config
