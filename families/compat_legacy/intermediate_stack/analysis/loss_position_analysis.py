...
def load_data():
    """載入分析數據"""
    analysis_dir = Path('/home/sbplab/ruizi/WavTokenize-feature-analysis/families/compat_legacy/intermediate_stack/analysis')
...
def analyze_before_after():
    ...
    plt.tight_layout()
    plt.savefig('/home/sbplab/ruizi/WavTokenize-feature-analysis/families/compat_legacy/intermediate_stack/analysis/loss_position_analysis.png',
