...
# ============================================================
# exp_0128 Phase 3-2: Exp 6b - β sweep (commitment weight)
# ============================================================
...
if [ -z "${1}" ]; then
  echo "Usage: bash exp_0128/phase3-2/run_exp6b.sh <beta_commit>"
  echo "Example: bash exp_0128/phase3-2/run_exp6b.sh 0.5"
  exit 2
fi
...
OUTPUT_DIR="exp_0128/phase3-2/run_exp6b_beta${BETA_TAG}_${TIMESTAMP}"

echo "============================================================"
echo "Starting Exp 6b: β sweep (Phase 3-2)"
echo "============================================================"
...
echo ""
echo "============================================================"
echo "Exp 6b (beta_commit=${BETA_COMMIT}) Complete!"
