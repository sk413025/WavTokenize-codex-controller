...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python exp_0229b/train_bwe_latent.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python exp_0229b/train_bwe_latent.py \\
...
def main():
    ...
    BASE_DIR = Path(__file__).parent  # exp_0229b/
    if args.output_dir:
