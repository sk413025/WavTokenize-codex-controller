...
執行：
    ...
    python exp_0229c/train_bwe_latent_hf.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    python exp_0229c/train_bwe_latent_hf.py --mode epoch --epochs 300 --device cuda:1
"""
...
def main():
    ...
    BASE_DIR = Path(__file__).parent  # exp_0229c/
    if args.output_dir:
