...
執行：
    # Smoke test
    python families/deps/feat_align/train_no_vq_e2e.py --mode smoke

    # 正式訓練（從 exp_0225a 初始化）
    python families/deps/feat_align/train_no_vq_e2e.py --mode epoch --epochs 300 --device cuda:1 \\
        --encoder_ckpt families/deps/no_vq_scratch/runs/no_vq_scratch_epoch_20260224_032104/best_model_val_total.pt
"""
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/deps/feat_align/runs/no_vq_e2e_{args.mode}_{timestamp}')
