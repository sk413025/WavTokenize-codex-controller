"""
families/eval/decoder_lora_eval/eval_0226a.py

評估 exp_0226a（Encoder LoRA + Feature Alignment，Decoder Frozen）
並更新 comparison_results.json 和 comparison_table.md：

  - exp_0226a_best_total: best_model_val_total.pt (epoch=156, val_total=35.6065)
  - exp_0226a_best_mse:   best_model.pt (epoch=43, val_mse=0.02630)

執行：
    cd /home/sbplab/ruizi/WavTokenize-feature-analysis
    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python families/eval/decoder_lora_eval/eval_0226a.py
"""
...
EXP_0226A_RUN = 'families/deps/feat_align/runs/enc_feat_align_epoch_20260226_065054'
...
NEW_EXPERIMENTS = [
    {
        ...
        'folder': 'exp_0226a',
        'type': 'no_vq_enc_only',
        'ckpt': f'{EXP_0226A_RUN}/best_model_val_total.pt',
        'lora_rank': 64, 'lora_alpha': 128,
        'note': 'best_model_val_total.pt (epoch=156, val_total=35.6065; encoder-only + feat-align)',
    },
]
...
def rebuild_comparison_table(all_results):
    ...
    lines.append("- **exp_0226**（E2E LoRA，ep142）：目前 PESQ 最高但音檔有機械音（phase artifact）")
