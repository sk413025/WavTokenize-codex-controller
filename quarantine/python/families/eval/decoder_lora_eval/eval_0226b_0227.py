"""
families/eval/decoder_lora_eval/eval_0226b_0227.py
...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python families/eval/decoder_lora_eval/eval_0226b_0227.py
"""
...
NEW_EXPERIMENTS = [
    {
        ...
        'folder': 'exp_0226b',
        'type': 'no_vq_enc_only',
        'ckpt': 'families/deps/feat_align/runs/enc_hf_mel_epoch_20260227_020028/best_model_val_total.pt',
    ...
    },
    {
        ...
        'folder': 'exp_0227',
        'type': 'no_vq_enc_only',
        'ckpt': 'families/deps/enc_mrd_fm/runs/enc_mrd_fm_epoch_20260227_024953/best_model_val_total.pt',
        'lora_rank': 64, 'lora_alpha': 128,
