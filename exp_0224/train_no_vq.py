...
執行：
    ...
    python exp_0224/train_no_vq.py --mode smoke

    # 正式訓練
    python exp_0224/train_no_vq.py --mode epoch --epochs 150 --device cuda:1
"""
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0224/runs/no_vq_{args.mode}_{timestamp}')
