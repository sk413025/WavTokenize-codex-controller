...
init ckpt:   exp_0217/runs/t453_weighted_epoch_20260217_104843/best_model.pt
```
...
Step 1: exp_0224a（Encoder LoRA 訓練）
    python exp_0224/train_no_vq.py --mode epoch --epochs 300 --device cuda:0
...
python exp_0224/train_no_vq.py \
    --mode epoch \
    --epochs 300 \
    --device cuda:0 \
    --encoder_ckpt exp_0217/runs/t453_weighted_epoch_20260217_104843/best_model.pt \
    --lora_rank 64 \
    --lora_alpha 128 \
    --lambda_wav 1.0 \
    --lambda_stft 1.0 \
...
python exp_0224/train_no_vq_decoder_lora.py \
    ...
    --epochs 300 \
    --device cuda:1 \
    --encoder_ckpt exp_0224/runs/no_vq_epoch_20260223_055458/best_model.pt \
