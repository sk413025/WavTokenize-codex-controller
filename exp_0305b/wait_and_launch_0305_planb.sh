...
# 用法: bash exp_0305b/wait_and_launch_0305_planb.sh &
set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
LOG_A="${ROOT_DIR}/exp_0305b/runs/expA_tail_lock_origWav_20260305_002937/train.log"
...
cd "${ROOT_DIR}"
nohup python exp_0305/train_selective_lora.py \
    --plan plan_b \
    --mode epoch \
    --epochs 300 \
    --device cuda:0 \
...
echo "${PLANB_PID}" > "${ROOT_DIR}/exp_0305/planb_pid.txt"
