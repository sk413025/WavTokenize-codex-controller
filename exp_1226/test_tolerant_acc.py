...
from exp_1201.config import VAL_CACHE, WAVTOK_CONFIG, WAVTOK_CKPT
from exp_1217.models import TeacherStudentConfigurableLoRA
from exp_1219.losses import compute_masked_accuracy
from exp_1226.losses_tolerant import FrameTolerantAccuracy
...
def main():
    ...
    checkpoint_dirs = [
        ...
        Path("exp_1226/runs/exp63_vq_aware"),
    ]
