...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python exp_0226/train_enc_feat_align.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python exp_0226/train_enc_feat_align.py \\
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0226/runs/enc_feat_align_{args.mode}_{timestamp}')
