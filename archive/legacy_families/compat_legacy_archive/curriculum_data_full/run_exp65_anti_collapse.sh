...
python families/compat_legacy/curriculum_data/train_exp65_anti_collapse.py \
    ...
    --output_dir /home/sbplab/ruizi/WavTokenize-self-supervised/families/compat_legacy/curriculum_data/runs/exp65_anti_collapse \
    --lora_rank 256 \
    --lora_alpha 512 \
    --lora_dropout 0.2 \
    --lora_layers all_18 \
    ...
    --warmup_epochs 10 \
    --grad_clip 1.0 \
    2>&1 | tee families/compat_legacy/curriculum_data/exp65.log
