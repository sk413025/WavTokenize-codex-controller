...
python families/compat_legacy/curriculum_data/train_exp66_post_vq.py \
    --exp_name exp68_post_vq_fixed \
    --output_dir /home/sbplab/ruizi/WavTokenize-self-supervised/families/compat_legacy/curriculum_data/runs/exp68_post_vq_fixed \
    --lora_rank 256 \
    --lora_alpha 512 \
    --lora_dropout 0.2 \
    --lora_layers all_18 \
    ...
    2>&1 | tee families/compat_legacy/curriculum_data/exp68.log
