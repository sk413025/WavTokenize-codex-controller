...
# ============================================================
# exp_0128 Phase 2: 實驗 4b-2 - Codebook Refresh (r=50, t=5)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase2/codebook_refresh/run_exp4b-2_${TIMESTAMP}"
REFRESH_INTERVAL=50
USAGE_THRESHOLD=5

echo "============================================================"
echo "Starting Experiment 4b-2: Codebook Refresh (r=50, t=5)"
echo "============================================================"
echo "GPU: 0"
