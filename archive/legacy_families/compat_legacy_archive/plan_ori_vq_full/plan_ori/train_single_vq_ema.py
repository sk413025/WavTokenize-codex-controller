...
執行：
    ...
    python families/compat_legacy/plan_ori_vq/plan_ori/train_single_vq_ema.py --steps 1000

    # Long-run (300 epochs)
    python families/compat_legacy/plan_ori_vq/plan_ori/train_single_vq_ema.py --epochs 300 --mode epoch
"""
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'families/compat_legacy/plan_ori_vq/runs/plan_ori_{args.mode}_{timestamp}')
