#!/bin/bash
# =============================================================================
# exp_0206 V2: Long-Term RVQ Training — Fixed Intermediate Weight
#
# V2 變更:
#   - intermediate_weight: 0.5 → 0.03 (固定，不再 warmdown)
#   - 移除 intermediate_weight_min, warmdown_epochs 參數
#   - 新增 NaN 保護機制
#
# 使用方法:
#   bash families/compat_legacy/plan_ori_vq/run_v2.sh        # 使用 GPU 0 (預設)
#   bash families/compat_legacy/plan_ori_vq/run_v2.sh 1      # 使用 GPU 1
#   bash families/compat_legacy/plan_ori_vq/run_v2.sh 2      # 使用 GPU 2
# =============================================================================
set -eo pipefail
...
python families/compat_legacy/plan_ori_vq/train_long_v2.py \
    --exp_name "$EXP_NAME" \
    --seed 42 \
    \
    --num_epochs 300 \
