...
執行:
    python families/compat_legacy/intermediate_stack/train_v2.py --exp_name exp_k_v2 --loss_type normalized_mse
"""
...
from families.compat_legacy.intermediate_stack.models_v2 import IntermediateSupervisionLossV2
