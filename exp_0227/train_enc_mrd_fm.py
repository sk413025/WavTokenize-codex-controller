...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python exp_0227/train_enc_mrd_fm.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python exp_0227/train_enc_mrd_fm.py \\
...
# ============================================================
# Standard Losses（與 exp_0226a 相同）
# ============================================================
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0227/runs/enc_mrd_fm_{args.mode}_{timestamp}')
