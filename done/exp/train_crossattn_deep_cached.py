...
def main():
    ...
    wavtokenizer = WavTokenizer.from_pretrained0802('config/wavtokenizer_mediumdata_frame75_3s_nq1_code4096_dim512_kmeans200_attn.yaml', 'models/wavtokenizer_large_speech_320_24k.ckpt')
    wavtokenizer = wavtokenizer.to(device); wavtokenizer.eval()
