...
def main() -> int:
    ...
    results = {
        ...
        "source": "exp_0217/analysis_commit_5e859b0/audio_quality_by_epoch.json",
        "methods": {
    ...
    append_section(
        ...
        f"- Detailed tests: `exp_0217/analysis_commit_5e859b0/{OUT_JSON.name}`\n"
        f"- Human summary: `exp_0217/analysis_commit_5e859b0/{OUT_MD.name}`",
    )
    append_section(
        STRAT_MD,
        "## Statistical Tests Reference\n"
        f"- Pairwise Mann-Whitney + FDR: `exp_0217/analysis_commit_5e859b0/{OUT_MD.name}`",
    )
