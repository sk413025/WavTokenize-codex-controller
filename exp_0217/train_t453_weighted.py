...
基於 exp_0216/train_augmented.py 修改，核心變更：
...
執行：
    ...
    python exp_0217/train_t453_weighted.py --mode step --steps 1000

    # Long-run (300 epochs) - 完整實驗
    python exp_0217/train_t453_weighted.py --mode epoch --epochs 300
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0217/runs/t453_weighted_{args.mode}_{timestamp}')
