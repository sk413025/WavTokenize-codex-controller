...
執行方式：
    python exp_0225/train_no_vq_scratch_decoder_lora_phase.py \\
    ...
    # Smoke test
    python exp_0225/train_no_vq_scratch_decoder_lora_phase.py --mode smoke
"""
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0225/runs/no_vq_scratch_dec_lora_phase_{args.mode}_{timestamp}')
