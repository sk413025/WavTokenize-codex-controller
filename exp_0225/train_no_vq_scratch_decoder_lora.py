...
執行順序（必須先跑完 exp_0225a）：
    ...
    python exp_0225/train_no_vq_scratch_decoder_lora.py \
    ...
    # Smoke test
    python exp_0225/train_no_vq_scratch_decoder_lora.py --mode smoke
"""
...
def main():
    ...
    parser.add_argument('--encoder_ckpt', type=str, default=str(EXP0217_BEST_CKPT),
                        help='Encoder checkpoint 路徑。應指定 exp_0225a best_model_val_total.pt，'
                             '例如: exp_0225/runs/no_vq_scratch_epoch_*/best_model_val_total.pt')
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0225/runs/no_vq_scratch_dec_lora_{args.mode}_{timestamp}')
