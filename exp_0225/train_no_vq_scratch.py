...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python exp_0225/train_no_vq_scratch.py --mode smoke

    # 正式訓練
    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python exp_0225/train_no_vq_scratch.py \\
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0225/runs/no_vq_scratch_{args.mode}_{timestamp}')
