...
# ============================================================
# exp_0128 Phase 3: 實驗 5a - RVQ (2 layers, 2048 codes/layer)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase3/residual_vq/run_exp5a_${TIMESTAMP}"
N_LAYERS=2
CODEBOOK_SIZE=2048

echo "============================================================"
echo "Starting Experiment 5a: RVQ (2 layers, 2048 codes/layer)"
echo "============================================================"
echo "GPU: 0"
echo "RVQ Layers: ${N_LAYERS}"
echo "Codebook Size per Layer: ${CODEBOOK_SIZE}"
echo "Total Expressiveness: ${CODEBOOK_SIZE}^${N_LAYERS} = $((CODEBOOK_SIZE**N_LAYERS))"
