...
# ============================================================
# exp_0128 Phase 3-2: Exp 6c - EMA + dead-code reset
# ============================================================
...
if [ -z "${1}" ]; then
  echo "Usage: bash exp_0128/phase3-2/run_exp6c.sh <dead_code_threshold> [beta_commit]"
  echo "Example: bash exp_0128/phase3-2/run_exp6c.sh 2 1.0"
  exit 2
fi
...
OUTPUT_DIR="exp_0128/phase3-2/run_exp6c_ema_th${TH_TAG}_beta${BETA_TAG}_${TIMESTAMP}"

echo "============================================================"
echo "Starting Exp 6c: EMA + dead-code reset (Phase 3-2)"
echo "============================================================"
...
# Spec: run to step 200 for P1 gate first.
...
echo ""
echo "============================================================"
echo "Exp 6c (th=${DEAD_CODE_THRESHOLD}, beta_commit=${BETA_COMMIT}) Complete!"
