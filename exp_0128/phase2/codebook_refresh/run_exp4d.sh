...
# ============================================================
# exp_0128 Phase 2: 實驗 4d - Codebook Refresh (r=50, t=5)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase2/codebook_refresh/run_exp4d_${TIMESTAMP}"
REFRESH_INTERVAL=50
USAGE_THRESHOLD=5

echo "============================================================"
echo "Starting Experiment 4d: Codebook Refresh (r=50, t=5)"
echo "============================================================"
echo "GPU: 0"
