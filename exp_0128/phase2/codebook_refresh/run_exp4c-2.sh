...
# ============================================================
# exp_0128 Phase 2: 實驗 4c-2 - Codebook Refresh (r=200, t=20)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase2/codebook_refresh/run_exp4c-2_${TIMESTAMP}"
REFRESH_INTERVAL=200
USAGE_THRESHOLD=20

echo "============================================================"
echo "Starting Experiment 4c-2: Codebook Refresh (r=200, t=20)"
echo "============================================================"
echo "GPU: 0"
