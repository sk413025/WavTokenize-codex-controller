...
# ============================================================
# exp_0128 Phase 2: 實驗 3b - Entropy Regularization (λ=0.05)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase2/entropy_regularization/run_exp3b_${TIMESTAMP}"
LAMBDA_ENTROPY=0.05

echo "============================================================"
echo "Starting Experiment 3b: Entropy Regularization (λ=0.05)"
echo "============================================================"
echo "GPU: 0"
