...
# ============================================================
# exp_0128 Phase 2: 實驗 3a - Entropy Regularization (λ=0.01)
# ============================================================
...
OUTPUT_DIR="exp_0128/phase2/entropy_regularization/run_exp3a_${TIMESTAMP}"
LAMBDA_ENTROPY=0.01

echo "============================================================"
echo "Starting Experiment 3a: Entropy Regularization (λ=0.01)"
echo "============================================================"
echo "GPU: 0"
