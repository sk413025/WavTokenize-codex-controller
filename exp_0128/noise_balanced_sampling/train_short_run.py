...
目的：
- 驗證「噪音材質平衡抽樣」是否能改善 token collapse
...
執行：
    CUDA_VISIBLE_DEVICES=1 python exp_0128/noise_balanced_sampling/train_short_run.py \\
        --steps 1000 \\
        --batch_size 2 \\
        --output_dir exp_0128/noise_balanced_sampling/run_short \\
        --seed 42
"""
...
def plot_loss_curves(loss_history, save_path):
    ...
    fig.suptitle('Exp 0128-2: Noise-Balanced Sampling', fontsize=12)
...
def main():
    parser = argparse.ArgumentParser(description='Exp 0128 - Noise-Balanced Short-Run')
    parser.add_argument('--steps', type=int, default=1000, help='Total training steps')
    parser.add_argument('--batch_size', type=int, default=2, help='Batch size')
    parser.add_argument('--grad_accum', type=int, default=2, help='Gradient accumulation steps')
    parser.add_argument('--lr', type=float, default=1e-4, help='Learning rate')
    parser.add_argument('--output_dir', type=str, default='exp_0128/noise_balanced_sampling/run_short',
    ...
    # Save config
    config = vars(args)
    config['experiment'] = 'exp_0128_noise_balanced_sampling'
    ...
    print("=" * 60)
    print("Exp 0128: Noise-Balanced Sampling Short-Run")
    print("=" * 60)
    ...
    # Create dataloaders with Noise-Balanced Sampler
