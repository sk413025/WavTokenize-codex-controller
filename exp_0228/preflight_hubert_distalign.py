...
DEFAULT_ENCODER_CKPT = "exp_0225/runs/no_vq_scratch_epoch_20260224_032104/best_model_val_total.pt"
...
def main() -> int:
    ...
    if missing_required:
        ...
        summary = "Required assets are missing for exp_0228."
    elif gpu.get("status") != "ok":
        status = "blocked"
        recommended_next_action = "fix_gpu_probe"
        summary = "GPU readiness could not be established for exp_0228."
    else:
