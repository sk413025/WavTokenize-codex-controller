...
WAIT_PATTERN="exp_0228/train_enc_hubert_fm.py --mode epoch --epochs 300 --device cuda:0 --batch_size 8 --grad_accum 2"

WAIT_LOG="${WORKDIR}/exp_0228/nohup_wait_start_distalign.log"
TRAIN_LOG="${WORKDIR}/exp_0228/nohup_train_distalign.log"
LOCK_FILE="${WORKDIR}/exp_0228/.wait_then_start_distalign.lock"
...
nohup "${PY_BIN}" exp_0228/train_enc_hubert_fm_distalign.py \
  --mode epoch \
  --epochs 300 \
  --device cuda:0 \
  --batch_size 8 \
