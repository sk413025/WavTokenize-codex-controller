...
執行：
    ...
    /home/sbplab/miniconda3/envs/test/bin/python exp_0228/train_enc_hubert_fm.py --mode smoke

    PYTHONPATH=/home/sbplab/ruizi/WavTokenize-self-supervised:$PYTHONPATH \\
    /home/sbplab/miniconda3/envs/test/bin/python exp_0228/train_enc_hubert_fm.py \\
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0228/runs/enc_hubert_fm_{args.mode}_{timestamp}')
