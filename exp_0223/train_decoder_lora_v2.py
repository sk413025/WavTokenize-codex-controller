...
執行：
    # Smoke test
    python exp_0223/train_decoder_lora_v2.py --mode smoke --epochs 5

    # 正式訓練（繼承 v1 checkpoint）
    python exp_0223/train_decoder_lora_v2.py \\
        --mode epoch --epochs 150 --device cuda:0 \\
        --resume_from exp_0223/runs/decoder_lora_epoch_20260223_010247/best_model.pt
...
def main():
    ...
    if args.output_dir:
        ...
        exp_dir = Path(f'exp_0223/runs/decoder_lora_v2_{args.mode}_{timestamp}')
