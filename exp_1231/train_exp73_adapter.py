...
from exp_1231.models import TeacherStudentWithAdapter
...
def main():
    parser = argparse.ArgumentParser(description='Exp73: Denoising Adapter')
    parser.add_argument('--exp_name', type=str, default='exp73_adapter')
    ...
    parser.add_argument('--adapter_expansion', type=int, default=4)
    ...
    parser.add_argument('--soft_token_weight', type=float, default=0.5)
    ...
    print("=" * 60)
    print(f"Exp73: Denoising Adapter")
    print("=" * 60)
    print(f"Adapter Config:")
    print(f"  Type: {args.adapter_type}")
    print(f"  Expansion: {args.adapter_expansion}")
    print(f"  Layers: {args.adapter_num_layers}")
    print("=" * 60)
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        # 繪製訓練曲線
        plot_metrics(history, exp_dir, exp_type='adapter')
