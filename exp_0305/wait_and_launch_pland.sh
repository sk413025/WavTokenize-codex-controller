...
# 用法: bash exp_0305/wait_and_launch_pland.sh &

set -euo pipefail

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
PLANB_LOG_DIR="${ROOT_DIR}/exp_0305/runs/plan_b_epoch_20260306_052339"
...
LOG_PLAND="${ROOT_DIR}/exp_0305/nohup_pland_${TS}.log"
...
echo "${PID}" > "${ROOT_DIR}/exp_0305/pland_pid.txt"
echo "[$(date)] 完成！監控："
