...
執行：
  python exp_0305/visualize_layer_decision.py
"""
...
# ============================================================
# 數據（直接來自 exp_0304/conv18_14wav_role_metrics.csv）
# ============================================================
...
def main():
    ...
    # 同時輸出文字摘要
    summary = {
        'generated_by': f'exp_0305/visualize_layer_decision.py ({date_str})',
        'evidence_source': 'exp_0304/wavtokenizer_featuremap_14wav_extended/conv18_14wav_role_metrics.csv',
        'decision_criteria': {
