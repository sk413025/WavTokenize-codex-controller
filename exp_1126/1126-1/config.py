...
DATA_ROOT = Path("/home/sbplab/ruizi/c_code/done/exp/data3")  # 使用 data3 數據
...
# Distance Matrix (VQ codebook pairwise distances) - 使用修正後的正 L2 距離
...
class TrainConfig:
    ...
    save_interval: int = 20         # Same as save_every_n_epochs (for train.py compatibility)
