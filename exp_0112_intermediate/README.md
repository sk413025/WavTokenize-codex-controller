...
```bash
# 即時查看 log
tail -f exp_0112_intermediate/exp_k_v5.log

# 查看 GPU 使用
watch -n 1 nvidia-smi

# 查看最新結果
tail -20 exp_0112_intermediate/exp_k_v5.log | grep -E "Epoch|Val|Best"
```
...
```bash
# 查看訓練曲線
ls exp_0112_intermediate/runs/exp_k_v5_*/training_curves.png

# 查看音檔樣本
ls exp_0112_intermediate/runs/exp_k_v5_*/audio_samples/
```
...
## 背景
閱讀 exp_0112_intermediate/README.md 的「實驗目標」章節，理解：
- 核心問題：噪音敏感層梯度信號太弱
- 解決方案：中間層直接監督
...
## 執行
1. 如果從頭開始：bash exp_0112_intermediate/run_exp_k_v5.sh
2. 如果繼續訓練：bash exp_0112_intermediate/run_exp_k_v5_continue.sh
...
- [exp_1226](../exp_1226/) - Curriculum Learning
