...
# 使用 exp_0112_intermediate/analyze_noise_sensitivity.py 的結果
...
plt.tight_layout()
plt.savefig('/home/sbplab/ruizi/WavTokenize-feature-analysis/exp_0112_intermediate/analysis/noise_sensitivity_correct.png',
