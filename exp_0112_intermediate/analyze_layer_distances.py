...
def main():
    ...
    # 載入訓練好的權重 (如果有)
    checkpoint_path = Path('/home/sbplab/ruizi/WavTokenize-feature-analysis/exp_0112_intermediate/runs/exp_k_v2_20260115_020445/best_model.pt')
    ...
    # 保存結果
    output_dir = Path('/home/sbplab/ruizi/WavTokenize-feature-analysis/exp_0112_intermediate/analysis')
