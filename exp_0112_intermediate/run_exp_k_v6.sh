...
#
# 執行:
#   bash exp_0112_intermediate/run_exp_k_v6.sh [GPU_ID]
# ============================================================
...
python exp_0112_intermediate/train_v6.py \
    --exp_name "${EXP_NAME}" \
    --seed 42 \
    --lora_rank 256 \
    --lora_alpha 512 \
...
echo "Checkpoints: exp_0112_intermediate/runs/${EXP_NAME}/checkpoints/"
echo "============================================================"
